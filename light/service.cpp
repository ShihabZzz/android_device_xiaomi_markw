...
const static std::string kLcdBacklightPath =
    "/sys/class/leds/lcd-backlight/brightness";
const static std::string kLcdMaxBacklightPath =
...
int main() {
  ...
  if (!lcdMaxBacklight) {
    LOG(ERROR) << "Failed to open " << kLcdMaxBacklightPath
  ...
  android::sp<ILight> service = new Light(
      {std::move(lcdBacklight), lcdMaxBrightness}, old_led_driver,
